...
# BROKEN - http://datafinder.org/metadata/transit_schedule_google_feed.html
# Now here - https://gisdata.mn.gov/dataset/us-mn-state-metc-trans-transit-schedule-google-fd
...
# =============================================================================
old_location = "ftp://gisftp.metc.state.mn.us/google_transit.zip" 
location = "https://svc.metrotransit.org/mtgtfs/gtfs.zip"
